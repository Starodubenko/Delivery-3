...
<fmt:bundle basename="i18n.messages">
    <form id="findForm">
        ...
        <table>
            <tr>
                <dt><input type="text" class="form-control" name="order-id" id="order-id"
                           value="39"></dt>
                <dt><input type="text" class="form-control searchDate" name="order-date"
                           id="order-date"
                           value="2014-09-14"></dt>
                <dt><input type="text" class="form-control" name="order-goods-name"
                           id="order-goods-name"
                           value="Water 20L"></dt>
                <dt><input type="text" class="form-control" name="order-goods-count"
                           id="order-goods-count"
                           value=""></dt>
                <dt><input type="text" class="form-control" name="order-cost" id="order-cost"
                           value=""></dt>
                <dt><input type="text" class="form-control searchDate" name="delivery-date"
                           id="delivery-date"
                           value=""></dt>
                <dt><input type="text" class="form-control" name="delivery-time"
                           id="delivery-time"
                           value=""></dt>
                <dt><input type="text" class="form-control" name="order-addInfo"
                           id="order-addInfo"
                           value=""></dt>
                <dt><input type="text" class="form-control" name="order-status"
                           id="order-status"
                           value=""></dt>
            </tr>
        </table>
